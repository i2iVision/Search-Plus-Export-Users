...
$dropbox = new DropboxClient(array(
	'app_key' => "2yiumoyh9yz10xh", 
	'app_secret' => "etex9mg2yqoxz51",
	'app_full_access' => false,
),'en');


// first try to load existing access token
$access_token = load_token("9xBz_RqYg6AAAAAAAAAA7ycedsuBw_YMUFEQz5eIw7EFoIyOw8Xz-GSVlR05haNA");
...
elseif(!empty($_GET['auth_callback'])) // are we coming from dropbox's auth page?
{
	...
	store_token($access_token, "9xBz_RqYg6AAAAAAAAAA7ycedsuBw_YMUFEQz5eIw7EFoIyOw8Xz-GSVlR05haNA");
